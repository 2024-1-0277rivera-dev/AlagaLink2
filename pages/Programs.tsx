...
import AdminEvaluationOverlay from '../components/programs/AdminEvaluationOverlay';
import PhilHealthPortal from '../components/programs/PhilHealthPortal';
import InventoryPortal from '../components/programs/InventoryPortal';
import FallbackImage from '../components/shared/FallbackImage';
import RegistrationWorkflow from '../components/members/RegistrationWorkflow';
...
const Programs: React.FC = () => {
  ...
  const [medicalServices, setMedicalServices] = useState<MedicalService[]>(MOCK_MEDICAL);
        ...
        <div className="bg-white dark:bg-alaga-charcoal p-12 rounded-[48px] border border-gray-100 dark:border-white/5 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.15)] relative overflow-hidden inflated-card">
          <div className="flex flex-col md:flex-row items-center gap-8 mb-10 border-b border-gray-100 dark:border-white/5 pb-8">
             <div className="w-28 h-28 bg-alaga-blue/5 rounded-[32px] overflow-hidden shadow-xl border-4 border-white dark:border-white/10 shrink-0">
               <FallbackImage src={item.photoUrl} className="w-full h-full object-cover" alt={item.photoAlt || item.name || item.title} fallbackType={item.section || 'Generic'} />
             </div>
