  ...
  if (activeRegistration) {
    return (
      <div className="min-h-screen bg-alaga-gray dark:bg-alaga-navy p-4 md:p-12">
        <button onClick={() => setActiveRegistration(null)} className="mb-8 flex items-center gap-3 px-6 py-3 bg-white dark:bg-white/5 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl hover:scale-105 transition-all">
          ...
          <div className="bg-white/10 backdrop-blur-3xl p-10 md:p-16 rounded-[48px] border border-white/20 shadow-[0_50px_100px_rgba(0,0,0,0.3)] space-y-10">
            ...
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div className="relative group">
                ...
                <input required type="password" value={password} onChange={(e) => {setPassword(e.target.value); setLoginError('');}} placeholder="Enter your password..." className="w-full pl-12 pr-6 py-4 bg-white/15 border-2 border-white/20 focus:border-white rounded-[16px] font-medium text-base placeholder:text-white/40 outline-none transition-all focus:bg-white/20" />
              </div>
              ...
              <button type="submit" className="w-full py-4 rounded-[16px] bg-white text-alaga-blue font-black uppercase tracking-widest text-sm hover:shadow-lg hover:shadow-white/50 hover:scale-105 transition-all active:scale-95 flex items-center justify-center gap-2"><i className="fa-solid fa-arrow-right-to-bracket"></i> Log In</button>
            </form>
