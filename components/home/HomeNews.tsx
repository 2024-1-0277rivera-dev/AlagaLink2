          ...
          <div className="lg:col-span-7 lg:pr-8 lg:border-r border-gray-200 dark:border-white/10 space-y-6">
            ...
            >
              <div className="space-y-2">
                <span className={`text-[10px] uppercase tracking-widest ${getBadgeStyle(filteredItems[0].type)}`}>
                  {filteredItems[0].type} • {filteredItems[0].date}
                </span>
              ...
              >
                <div className="flex gap-4">
                  <div className="flex-1 space-y-2">
                    <span className={`text-[9px] uppercase tracking-widest ${getBadgeStyle(item.type)}`}>
                      {item.type}
                    </span>
