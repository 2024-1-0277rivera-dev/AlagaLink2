      ...
      <div className="absolute inset-0 flex flex-col justify-end p-6 md:p-16">
        <div className={`space-y-3 md:space-y-4 transition-all duration-700 ease-out transform ${isTransitioning ? 'opacity-0 translate-y-8' : 'opacity-100 translate-y-0'}`}>
          <div className="flex items-center gap-2">
            <span className={`${getBadgeColor(currentUpdate.type)} text-white text-[8px] md:text-[10px] font-black px-3 md:px-4 py-1.5 rounded-full uppercase tracking-widest shadow-lg flex items-center gap-2`}>
