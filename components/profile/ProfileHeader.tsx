...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({ user }) => {
  const { setIsRoleSwitcherOpen } = useAppContext();
        ...
        <div className="flex flex-col items-center md:items-start md:flex-row md:items-end justify-between gap-10">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4">
            <button 
              ...
              className="px-10 py-5 bg-alaga-gold text-alaga-navy rounded-[28px] font-black text-sm transition-all flex items-center gap-3 shadow-[0_20px_40px_rgba(255,212,59,0.3)] hover:scale-105 active:scale-95 inner-glow border-2 border-white/20"
            >
