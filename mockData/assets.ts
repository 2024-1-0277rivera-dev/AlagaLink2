 ...
 * This file acts as the local storage for municipal image assets.
 * Since there is no backend database, we use high-quality Unsplash references
 * as 'local' assets and provide Base64 support for manual uploads.
 */
...
/**
 * Utility to convert uploaded file to Base64 for 'local' state storage
 */
